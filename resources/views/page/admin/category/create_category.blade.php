                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('category.store')}}" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" id="category_name" name="category_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Nama Kategori"  />
                        </div>
                        @error('category_name')
