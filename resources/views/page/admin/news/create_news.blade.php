                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('news.store')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="category_name" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Judul"  />
                            @error('title')
                        ...
                        <div class="mb-5">
                            <label for="category_name" class="block mb-2 text-sm font-medium text-gray-900 ">Konten</label>
